...
class Categoria(models.Model):
    ...
    nome_categoria = models.CharField(max_length=100, null=False, blank=False, verbose_name="Categoria")
    descricao_categoria = models.TextField(max_length=200, blank=True, null=True, verbose_name="Descrição")
